...
def run_tests():
    print("Starting verification checks for utils.py...")
    ...
    vars_found = utils.extract_variables(fields)
    ...
    escaped = utils.safe_html_render(malicious)
    ...
    compiled = utils.compile_template(template, {"word": "dog"})
    ...
    print("\nAll tests completed successfully! utils.py functions correctly.")
